...
# API_URL = "https://agentx123.app.n8n.cloud/webhook/23ee85b0-c920-490b-8f47-6a6d3f24db90/chat"

# st.set_page_config(page_title="IBT Smart Wakeel", page_icon="🤖")
# st.title("IBT Smart Wakeel")
...
#     if not r.ok:
#         bot_reply = f"❌ HTTP {r.status_code}\nReply: {r.text[:800]}"
#     else:
...
#     margin-right: 30%;
#     line-height: 1.45;        /* slightly looser but consistent */
#     font-size: 0.95rem;
#     padding: 10px 14px;       /* clean padding */
#     border-radius: 14px;
# }

# /* Normalize text inside assistant bubble */
# .bubble-assistant p,
# .bubble-assistant ul,
# .bubble-assistant ol {
#     margin: 4px 0;           /* same margin for all text blocks */
#     padding-left: 20px;      /* indent for bullets */
# }

# /* List items */
# .bubble-assistant li {
#     margin: 2px 0;           /* reduce gap between bullets */
#     line-height: 1.45;       /* same as paragraphs */
# }
...
#     """Keep viewport pinned to the latest content (no jump to top)."""
#     st.markdown("""
#         <script>
...
#     typing_placeholder.markdown("<div class='typing'>Waqeel is typing…</div>", unsafe_allow_html=True)
#     scroll_to_bottom()
...
# # Footer
# # st.markdown("<div class='footer'>Tip: use the chips above.</div>", unsafe_allow_html=True)
# # st.markdown("<div class='footer'>Tip: use the chips above. Open the ▸ in the top-left for Controls.</div>", unsafe_allow_html=True)

# # Final nudge to bottom if we already have messages
# if ss.history:
#     scroll_to_bottom()
