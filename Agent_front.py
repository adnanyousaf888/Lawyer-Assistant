...
#     # --- WORD-BY-WORD TYPING EFFECT (ADDED) ---
#     typing_placeholder.empty()
#     animated_placeholder = st.empty()
#     partial = ""

#     # split into words + keep whitespace blocks to preserve spacing/newlines
#     for chunk in re.split(r'(\s+)', reply):
#         partial += chunk
...
#         )
#         scroll_to_bottom()
#         time.sleep(0.02)  # typing speed (seconds per chunk). Adjust if you like.
#     # --- END ADD ---

#     # Save the full message to history and complete as before
#     add_msg("assistant", reply)
#     ss.pending_prompt = ""
#     ss.busy = False
#     scroll_to_bottom()
